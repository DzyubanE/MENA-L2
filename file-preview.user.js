// ==UserScript==
// @name         File Preview Team B BETA
// @namespace    http://tampermonkey.net/
// @version      1.3.0
// @updateURL    https://github.com/DzyubanE/MENA-L2/raw/refs/heads/main/file-preview.user.js
// @downloadURL  https://github.com/DzyubanE/MENA-L2/raw/refs/heads/main/file-preview.user.js
// @description  Превью вложений при наведении на ссылку в таблице и полноэкранный просмотр с поворотом на 90°, масштабированием колесом мыши и перетаскиванием
// @author       you
...
// @icon         https://raw.githubusercontent.com/DzyubanE/MENA-L2/refs/heads/main/file-preview.png
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  function log(...args) {
    if (CONFIG.debug) console.log('[FilePreview]', ...args);
  }
